...
| Skill                          | Path                                                                      |
| ------------------------------ | ------------------------------------------------------------------------- |
| skill-index                    | `ai/skills/skill-index/SKILL.md`                                     |
| test-generator                 | `ai/skills/test-generator/SKILL.md`                                  |
| route-catalog                  | `ai/skills/route-catalog/SKILL.md`                                   |
| openapi-route-sync             | `ai/skills/openapi-route-sync/SKILL.md` (legacy — tag locale only; use route-schema-doc-guard for schema) |
| route-schema-doc-guard         | `ai/skills/route-schema-doc-guard/SKILL.md`                          |
| seed-maintainer                | `ai/skills/seed-maintainer/SKILL.md`                                 |
| domain-generator               | `ai/skills/domain-generator/SKILL.md`                                |
| schema-generator               | `ai/skills/schema-generator/SKILL.md`                                |
| sql-design-guard               | `ai/skills/sql-design-guard/SKILL.md`                                |
| db-migration-maintainer        | `ai/skills/db-migration-maintainer/SKILL.md`                         |
| workers-events                 | `ai/skills/workers-events/SKILL.md`                                  |
| supabase-porting               | `ai/skills/supabase-porting/SKILL.md`                                |
| code-quality-guard             | `ai/skills/code-quality-guard/SKILL.md`                              |
| code-smells-and-best-practices | `ai/skills/code-smells-and-best-practices/SKILL.md`                  |
| lint-warnings-handler          | `ai/skills/lint-warnings-handler/SKILL.md` (detail; via code-smells) |
| before-commit-guard            | `ai/skills/before-commit-guard/SKILL.md`                             |
| dependency-security            | `ai/skills/dependency-security/SKILL.md`                             |
| structure-maintainer           | `ai/skills/structure-maintainer/SKILL.md`                            |
| production-hardening-guard     | `ai/skills/production-hardening-guard/SKILL.md`                      |
| path-to-production-gate        | `ai/skills/path-to-production-gate/SKILL.md`                         |
| i18n-message-guard             | `ai/skills/i18n-message-guard/SKILL.md`                              |
| openapi-multilingual           | `ai/skills/openapi-multilingual/SKILL.md`                            |
| env-schema-add                 | `ai/skills/env-schema-add/SKILL.md`                                  |
| ide-productivity-guard         | `ai/skills/ide-productivity-guard/SKILL.md`                          |
| docs-maintainer                | `ai/skills/docs-maintainer/SKILL.md`                                 |
| docs-audit                     | `ai/skills/docs-audit/SKILL.md`                                      |
| system-narrative-maintainer    | `ai/skills/system-narrative-maintainer/SKILL.md`                     |
| overview-doc-maintainer        | `ai/skills/overview-doc-maintainer/SKILL.md`                         |
| tsdoc-export-guard             | `ai/skills/tsdoc-export-guard/SKILL.md`                              |
| setup-infra-maintainer         | `ai/skills/setup-infra-maintainer/SKILL.md`                          |
| pr-babysit                     | `ai/skills/pr-babysit/SKILL.md`                                      |
| split-to-prs                   | `ai/skills/split-to-prs/SKILL.md`                                    |
| ci-investigator                | `ai/skills/ci-investigator/SKILL.md`                                 |
| contract-test-maintainer       | `ai/skills/contract-test-maintainer/SKILL.md`                        |
| chaos-test-maintainer          | `ai/skills/chaos-test-maintainer/SKILL.md`                           |
| cursor-global-skills           | `ai/skills/cursor-global-skills/SKILL.md` (reference only)           |
...
| Created a new domain or sub-domain                                                                                                                                                                              | **domain-generator**                                                                                               | `ai/skills/domain-generator/SKILL.md`                        |
| Added event emission, queue, or worker                                                                                                                                                                          | **workers-events**                                                                                                 | `ai/skills/workers-events/SKILL.md`                          |
| Changed Biome rules, pre-commit hooks, guard orchestrator, or CI security | **code-quality-guard** + **before-commit-guard** | `ai/skills/code-quality-guard/SKILL.md` |
| Changed `package.json`, `pnpm-lock.yaml`, or dependency versions                                                                                                                                                | **dependency-security**                                                                                            | `ai/skills/dependency-security/SKILL.md`                     |
| Renamed/moved files, folders, or layers                                                                                                                                                                         | **structure-maintainer**                                                                                           | `ai/skills/structure-maintainer/SKILL.md`                    |
| Porting code from Supabase Edge Functions                                                                                                                                                                       | **supabase-porting**                                                                                               | `ai/skills/supabase-porting/SKILL.md`                        |
| Added/changed `migrations/*.sql` or schema needs SQL migration                                                                                                                                                  | **db-migration-maintainer**                                                                                        | `ai/skills/db-migration-maintainer/SKILL.md`                 |
| New/updated feature: routes, validators, serializers, utils, services, workers, or tests                                                                                                                        | **test-generator**                                                                                                 | `ai/skills/test-generator/SKILL.md` — unit vs domain pyramid |
| Added/modified domain tests or test factories only                                                                                                                                                              | **test-generator**                                                                                                 | `ai/skills/test-generator/SKILL.md`                          |
...
| Changed where tests live (test layout: Vitest under `src/`, root `tests/` only for k6)                                                                                                                          | **structure-maintainer**                                                                                           | `ai/skills/structure-maintainer/SKILL.md`                    |
...
| Changed a domain `seed/` dir (`*.reference.seed.ts`, `*.bulk.seed.ts`, `*.faker.ts`, `index.ts`), seed orchestrator/contract (`src/scripts/seed/**`), or added new seeded data                                   | **seed-maintainer** (+ `ai/rules/seed-conventions.mdc`)                                                        | `ai/skills/seed-maintainer/SKILL.md`                         |
| Modified middleware, infra, or security config                                                                                                                                                                  | **production-hardening-guard**                                                                                     | `ai/skills/production-hardening-guard/SKILL.md`              |
| **Before path-to-production action** (release, deploy, ready-for-production)                                                                                                                                    | **path-to-production-gate**                                                                                        | `ai/skills/path-to-production-gate/SKILL.md`                 |
| **Git commit** (pre-commit hook runs guard) or user asks to fix failed commit                                                                                                                                   | **before-commit-guard**                                                                                            | `ai/skills/before-commit-guard/SKILL.md`                     |
| Adding or editing code under `src/` (quality, lint warnings, best practices)                                                                                                                                    | **code-smells-and-best-practices** (uses **lint-warnings-handler** for warning details)                            | `ai/skills/code-smells-and-best-practices/SKILL.md`          |
| Changed k6 scenarios, load-test scripts, or load-test docs                                                                                                                                                      | **structure-maintainer** (keep `docs/reference/testing/load-testing.md` and `src/tests/load/k6/README.md` in sync) | `ai/skills/structure-maintainer/SKILL.md`                    |
| Added/edited user-facing message or translation key in errors, validators, services, controllers, constants, or locales                                                                                         | **i18n-message-guard**                                                                                             | `ai/skills/i18n-message-guard/SKILL.md`                      |
| Added/changed OpenAPI locale files or multilingual OpenAPI (src/shared/locales/\*/openapi.json, docs:generate:multilang)                                                                                        | **openapi-multilingual**                                                                                           | `ai/skills/openapi-multilingual/SKILL.md`                    |
| Changed env schema (`src/shared/config/env-schema.ts`) or `.env.example`                                                                                                                                        | **env-schema-add**                                                                                                 | `ai/skills/env-schema-add/SKILL.md`                          |
...
| Added/changed product slug, Docker/GHCR image names, git branches, or hosted env mapping in `src/`, `.github/workflows/`, or tooling (avoid new `'core-be'` / `core-be-api` literals) | Follow **`ai/rules/project-identity.mdc`**; use **`project-identity.constants.ts`**; regenerate if manifest touched | project-identity-sync rule, **openapi-multilingual** if locale openapi.json changes |
| Changed `.vscode/extensions.json` or `.vscode/settings.json`                                                                                                                                                    | **ide-productivity-guard**                                                                                         | `ai/skills/ide-productivity-guard/SKILL.md`                  |
| Added/renamed/moved a doc under `docs/` (hand-written .md); changed `docs/deployment/ci-cd/branch-protection.md` or `.github/rulesets/*.json`; or changed CI job `name:` fields referenced in branch protection | **docs-maintainer**                                                                                                | `ai/skills/docs-maintainer/SKILL.md`                         |
| User asks to "review docs" or "audit documentation"                                                                                                                                                             | **docs-audit**                                                                                                     | `ai/skills/docs-audit/SKILL.md`                              |
| Added/removed/changed a third-party provider in setup:infra (`tooling/setup/`)                                                                                                                                  | **setup-infra-maintainer**                                                                                         | `ai/skills/setup-infra-maintainer/SKILL.md`                  |
| User asks to babysit a PR, fix PR CI, or get branch merge-ready                                                                                                                                                 | **pr-babysit**                                                                                                     | `ai/skills/pr-babysit/SKILL.md`                              |
| User asks why a specific CI check failed                                                                                                                                                                        | **ci-investigator**                                                                                                | `ai/skills/ci-investigator/SKILL.md`                         |
| User asks to split work into multiple PRs                                                                                                                                                                       | **split-to-prs**                                                                                                   | `ai/skills/split-to-prs/SKILL.md`                            |
| Changed contract tests or Stripe/Resend/S3 client wrappers                                                                                                                                                      | **contract-test-maintainer**                                                                                       | `ai/skills/contract-test-maintainer/SKILL.md`                |
| Changed chaos tests, Toxiproxy provision, or chaos Docker profile                                                                                                                                               | **chaos-test-maintainer**                                                                                          | `ai/skills/chaos-test-maintainer/SKILL.md`                   |
| Added/changed `migrations/*.sql` only (no schema file in same change)                                                                                                                                           | **db-migration-maintainer**                                                                                        | `ai/skills/db-migration-maintainer/SKILL.md`                 |
| Added/changed a per-domain `seed/` dir (`*.reference.seed.ts` / `*.bulk.seed.ts` / `*.faker.ts` / `index.ts`) or `src/scripts/seed/**`                                                                           | **seed-maintainer** (+ `ai/rules/seed-conventions.mdc`)                                                        | `ai/skills/seed-maintainer/SKILL.md`                         |
...
The following `ai/rules/*.mdc` files auto-invoke skills based on file globs:
...
| `structure-maintainer-sync.mdc`           | `AGENTS.md`, `CLAUDE.md`, `README.md`, `ai/rules/**`, `ai/skills/**`, `ai/agents/**`                                                                                 | structure-maintainer                                                       |
...
Project-defined subagents in [`ai/agents/`](../../agents/) run in isolation (read-only) for heavy diagnostics:

| Subagent | File | Use when |
| -------- | ---- | -------- |
| **production-reviewer** | `ai/agents/production-reviewer.md` | Pre-release / deploy sign-off — full readiness plan |
| **verifier** | `ai/agents/verifier.md` | After claiming work complete — scoped validate/tests |
| **ci-investigator** | `ai/agents/ci-investigator.md` | One failing CI check — root cause without log noise |
