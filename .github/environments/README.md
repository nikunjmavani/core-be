...
JSON files here declare protection rules for [GitHub Environments](https://docs.github.com/en/actions/deployment/targeting-different-environments/using-environments-for-deployment) used by [cd.yml](../workflows/cd.yml).
...
4. Edit `.env.staging` with real values; update `.github/workflows/cd.yml`.
