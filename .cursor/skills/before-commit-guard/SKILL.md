...
| 6    | `pnpm tool:generate-project-identity:check`                         | Manifest-generated constants, sync config, and workflow branch/image literals in sync. Edit `tooling/setup/setup.config.json`, run `pnpm tool:generate-project-identity`, re-stage outputs. See **project-identity.mdc**.                                                                                                                                                                                                                                                                    |
| 7    | `pnpm tool:sync-env-example`                                        | `.env.example` vs env schema. Run `pnpm tool:sync-env-example --fix` if needed, add descriptions, re-commit.                                                                                                                                                                                                                                                                                                                  |
| 8    | `gitleaks protect --staged`                                         | Secrets in staged files (skipped if gitleaks not installed locally; CI always scans). Remove secrets; use env vars or `.env.example`. Manual full-repo scan: `pnpm security:secrets`.                                                                                                                                                                                                                                         |
| 9    | Conflict markers                                                    | Reject `<<<<<<<`, `>>>>>>>`, `=======` in staged files. Resolve merge conflicts.                                                                                                                                                                                                                                                                                                                                              |
| 10   | Large files                                                         | Reject staged added/copied/modified/renamed files > 1MB. Unstage or add to `.gitignore`; use LFS if needed.                                                                                                                                                                                                                                                                                                                   |
