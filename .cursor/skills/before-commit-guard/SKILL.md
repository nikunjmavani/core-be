...
| ---- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | `pnpm lint-staged`                                                                          | ESLint + Prettier on staged `src/**/*.ts`, `tooling/setup/**/*.ts`, and formatted `*.{json,yaml,yml,md}`. Run `pnpm lint` and `pnpm format`; fix per **code-smells-and-best-practices** (warning details in **lint-warnings-handler**).                                                                                |
...
| 4a   | When `src/domains/**/*.routes.ts` staged: `pnpm routes:catalog` + `git add docs/routes.txt` | Regenerates route catalog; re-stages generated file.                                                                                                                                                                                                                                                                   |
...
| 4c   | Always: `pnpm routes:catalog:check`                                                         | Fails if `docs/routes.txt` is out of sync.                                                                                                                                                                                                                                                                             |
...
3. **Apply the right skill** — Use **code-smells-and-best-practices**, **route-catalog**, **env-example-sync**, **dependency-security**, or **domain-generator** as needed.
