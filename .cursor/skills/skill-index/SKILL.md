...
| `contract-test-maintainer-sync.mdc`       | `src/tests/contract/**`, payment/mail/storage infra, `vitest.contract.config.ts`                                                                                                    | contract-test-maintainer                                                   |
| `chaos-test-maintainer-sync.mdc`          | `src/tests/chaos/**`, `vitest.chaos.config.ts`, chaos provision, `docker-compose.yml`                                                                                               | chaos-test-maintainer                                                      |
