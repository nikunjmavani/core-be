...
8. **Author layered docs** (required, gated by `pnpm features:check:strict`):
...
9. **Refresh the index** — invoke **feature-doc-maintainer** to regenerate per-folder `DOCS.md` and run the strict ratchet.
