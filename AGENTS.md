...
3. For new domains, routes, workers, or schema work, follow **[docs/getting-started/requirement-intake.md](docs/getting-started/requirement-intake.md)** and consult **[skill-index](ai/skills/skill-index/SKILL.md)** first (36 project skills; Cursor built-ins: **cursor-global-skills**) — run only the skills that match your changes (no duplicate invocations).
...
Project-defined subagents in [`ai/agents/`](ai/agents/) run in isolation
(read-only) for heavy diagnostics.

**Full catalog + use-when:** [ai/docs/agents-catalog.md](ai/docs/agents-catalog.md)
**Platform invocation (Cursor / Claude Code / Codex):** [ai/docs/platform-access.md](ai/docs/platform-access.md)
**Skill trigger map:** [ai/docs/skill-triggers.md](ai/docs/skill-triggers.md) — file pattern → which skill to invoke.
