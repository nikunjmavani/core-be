...
3. Open the PR to **dev** via the GitHub MCP (`create_pull_request`): a conventional title (or **$ARGUMENTS** if given) and a body summarizing what changed, why, and how it was verified. End the body with the Claude Code footer.
4. Report the PR URL.
