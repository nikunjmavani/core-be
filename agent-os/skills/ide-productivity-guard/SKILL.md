...
- **TypeScript:** workspace TS SDK, importModuleSpecifier non-relative (aligns with `agent-os/rules/import-paths.mdc` — `@/` in `src/`, `@tooling/` in tooling), importModuleSpecifierEnding `js`, autoImports, updateImportsOnFileMove always.
