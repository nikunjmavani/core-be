...
| A.3 — Infrastructure or shared module | `A.3-infra-shared` | `src/infrastructure/<module>/OVERVIEW.md`, `src/shared/<module>/OVERVIEW.md`, `src/core/<module>/OVERVIEW.md`, `src/scripts/<module>/OVERVIEW.md` |
...
- A new folder appears under `src/domains/`, `src/infrastructure/`, `src/shared/`, `src/core/`, `src/scripts/`, or `src/tests/<suite>/` and needs an `OVERVIEW.md`.
