...
export const PROJECT_SLUG = 'core-be' as const;

/** Human-facing product name for OpenAPI and emails. */
export const PROJECT_DISPLAY_NAME = 'core-be' as const;

/** Default OpenAPI `info.title` when locale strings omit a title. */
export const PROJECT_OPENAPI_TITLE = 'core-be API' as const;
...
export const MCP_URI_SCHEME = 'core-be' as const;

/** MCP resource URI for the bundled OpenAPI document. */
export const MCP_OPENAPI_RESOURCE_URI = 'core-be://openapi' as const;

/** MCP resource URI for the route catalog. */
export const MCP_ROUTES_RESOURCE_URI = 'core-be://routes' as const;

/** OpenTelemetry service name for the API process. */
export const OTEL_SERVICE_NAME_API = 'core-be-api' as const;

/** OpenTelemetry service name for the worker process. */
export const OTEL_SERVICE_NAME_WORKER = 'core-be-worker' as const;
...
export const DOCKER_LOCAL_API_TAG = 'core-be' as const;

/** Local Docker image tag for worker images in compose and CI. */
export const DOCKER_LOCAL_WORKER_TAG = 'core-be-worker' as const;

/** GHCR image repository name for the API container. */
export const GHCR_API_IMAGE_NAME = 'core-be-api' as const;

/** GHCR image repository name for the worker container. */
export const GHCR_WORKER_IMAGE_NAME = 'core-be-worker' as const;

/** GHCR Actions cache scope key for API image layers. */
export const GHCR_CACHE_SCOPE_API = 'core-be-api' as const;
...
export const GIT_PRODUCTION_BRANCH = 'main' as const;

/** Non-production deploy branch (maps to development GitHub Environment). */
export const GIT_NON_PRODUCTION_BRANCH = 'dev' as const;
