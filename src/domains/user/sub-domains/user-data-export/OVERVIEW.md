...
stateDiagram-v2
  ...
  bundle_ready --> expired: 24h URL TTL passes
...
- **Mail enqueue failure** → does not fail the export; the bundle exists in S3 and is downloadable for 24 h, but the user won't receive the email link.
