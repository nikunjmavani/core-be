...
/**
 * Zod schema for `POST /api/v1/organizations/:organization_id/api-keys` — requires a
...
/**
 * Zod schema for `PATCH /api/v1/organizations/:organization_id/api-keys/:api_key_id` —
...
/** Zod schema for the `GET /api/v1/organizations/:organization_id/api-keys` query string — cursor-based pagination only. */
