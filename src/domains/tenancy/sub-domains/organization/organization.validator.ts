...
/** Parses raw `PATCH /organizations/:organization_id` body via {@link updateOrganizationDto}; throws `ValidationError('errors:invalidInput')` on failure. */
...
/** Parses raw `PUT /organizations/:organization_id/logo` body via {@link uploadLogoDto}; throws `ValidationError('errors:invalidInput')` on failure. */
