 ...
 *
 * The raw 6-digit sign-in code is intentionally absent — it is dispatched only via
 * `AUTH_EVENT.MAGIC_LINK_REQUESTED` and the resulting email. Tests use
 * `captureNextMagicLinkCode` (src/tests/helpers/magic-link.helper.ts) to read it.
 *
