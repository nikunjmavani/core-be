/**
 * Container HEALTHCHECK entrypoint — probes worker GET /health (process up + not stalled).
 *
...
const liveProbeUrl = `http://${healthHost}:${String(env.WORKER_HEALTH_PORT)}/health`;
