...
| [integrations/credentials-and-env.md](integrations/credentials-and-env.md)     | Credentials for `.env` (S3, Resend, OAuth, Stripe, etc.).                  |
...
| [deployment/ci-cd/branch-protection.md](deployment/ci-cd/branch-protection.md)                             | Required CI checks for `main` / `dev` / `qa`.                             |
