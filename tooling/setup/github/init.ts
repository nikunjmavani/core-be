...
export async function runGithubInit(args: {
  ...
  /** Skip gh auth preflight (e.g. token-only callers with GITHUB_TOKEN set). */
  ...
  /**
   * Restrict the sync to these environment names (callers may run this once per environment, so
