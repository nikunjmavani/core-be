...
export function getFieldSpecificDescription(fieldName: string): string {
  const descriptions: Record<string, string> = {
    ...
    new_owner_user_id: 'Public ID of the user to transfer ownership to.',
    plan_id: 'Public ID of the subscription plan.',
    role_id: 'Public ID of the member role.',
    membership_id: 'Public ID of the membership.',
    organization_id: 'Public ID of the organization.',
    actor_user_id: 'Public ID of the user who performed the action.',
